...
worblim  push action eosio addproducer "{\"producer\":\"beyondbtc\"}" -p eosio
worblim  push action eosio addproducer "{\"producer\":\"bitfishrocks\"}" -p eosio
worblim  push action eosio addproducer "{\"producer\":\"blocksmithio\"}" -p eosio
worblim  push action eosio addproducer "{\"producer\":\"dune\"}" -p eosio
worblim  push action eosio addproducer "{\"producer\":\"eoscafeblock\"}" -p eosio
worblim  push action eosio addproducer "{\"producer\":\"eoscannon\"}" -p eosio
...
worblim  push action eosio addproducer "{\"producer\":\"bp.worbli \"}" -p eosio
